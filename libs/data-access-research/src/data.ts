import { researchArtifact } from "@site/data-access-core/domains/research";
import { validateCvDomain } from "@site/data-access-core/validators";

/**
 * The committed research domain, validated against the CV schema as this
 * module loads and exported as the only shape a feature reads it in.
 *
 * The import above reaches research.json and nothing else, so a feature that
 ...
 */
export const research = validateCvDomain("research", researchArtifact);
