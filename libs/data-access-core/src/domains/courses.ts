import artifact from "../../vendor/codegen/domains/courses.json" with {
  type: "json",
};

/**
 * The committed courses domain file, and nothing else.
 *
 ...
 * imports this one pulls in courses.json alone, where
 ...
 * `data-access-courses` library is what validates it, through
 * `validateCvDomain`, before exporting the slice a feature reads.
 */
export const coursesArtifact: unknown = artifact;
