import { skillsArtifact } from "@site/data-access-core/domains/skills";
import { validateCvDomain } from "@site/data-access-core/validators";

/**
 * The committed skills domain, validated against the CV schema as this
 * module loads and exported as the only shape a feature reads it in.
 *
 * The import above reaches skills.json and nothing else, so a feature that
 ...
 */
export const skills = validateCvDomain("skills", skillsArtifact);
